...
const dbName = 'test';
const collectionName = 'scholarships_test3';
...
// Call the scraping task at regular intervals (e.g., every 10 minutes)
const intervalMinutes = 2000;
setInterval(() => {
    console.log('Running the scraping task...');
    const { universityName, url } = getUniversityInfo();
    scrapScholarships(universityName, url);
}, intervalMinutes ); // Convert minutes to milliseconds
